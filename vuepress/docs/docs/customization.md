...
```scala
libraryDependencies += "com.devsisters" %% "shardcake-storage-redis" % "2.3.2"
```
...
```scala
libraryDependencies += "com.devsisters" %% "shardcake-protocol-grpc" % "2.3.2"
```
...
```scala
libraryDependencies += "com.devsisters" %% "shardcake-serialization-kryo" % "2.3.2"
```
...
```scala
libraryDependencies += "com.devsisters" %% "shardcake-health-k8s" % "2.3.2"
```
